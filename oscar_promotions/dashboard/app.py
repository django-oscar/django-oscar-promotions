...
class PromotionsDashboardApplication(DashboardApplication):
    ...
    list_view = get_class('oscar_promotions.dashboard.views', 'ListView')
    page_list = get_class('oscar_promotions.dashboard.views', 'PageListView')
    page_detail = get_class('oscar_promotions.dashboard.views', 'PageDetailView')
    create_redirect_view = get_class('oscar_promotions.dashboard.views', 'CreateRedirectView')
    delete_page_promotion_view = get_class('oscar_promotions.dashboard.views', 'DeletePagePromotionView')
