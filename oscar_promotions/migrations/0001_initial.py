    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    oscar.models.fields.ExtendedURLField(
                        blank=True, verbose_name="Link URL"
                    ),
                ),
                (
                    "link_text",
                ...
                (
                    ...
                    models.PositiveSmallIntegerField(
                        default=4, verbose_name="Number of Products"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "filter",
                    models.CharField(blank=True, max_length=200, verbose_name="Filter"),
                ),
                (
                    "content_type",
                    models.ForeignKey(
            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        blank=True,
                        help_text="Choose the Image content blocks that this block will use. (You may need to create some first).",
                        to="oscar_promotions.Image",
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "page_url",
                    oscar.models.fields.ExtendedURLField(
                        db_index=True, max_length=128, verbose_name="Page URL"
                    ),
                ),
                (
                    "content_type",
            ...
            fields=[
                (
                    ...
                    models.OneToOneField(
                        ...
                        primary_key=True,
                        serialize=False,
                        to="oscar_promotions.HandPickedProductList",
                    ),
                ),
                (
                    "display_order",
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="tabs",
                        to="oscar_promotions.TabbedBlock",
                        verbose_name="Tabbed Block",
                    ),
                ),
            ],
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                blank=True,
                through="oscar_promotions.OrderedProduct",
                to="catalogue.Product",
